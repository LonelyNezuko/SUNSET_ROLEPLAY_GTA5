...
try
{
	...
	mysql.connect(() =>
	{
		...
		npc.add([ -567.3302612304688, 5253.0546875, 70.47008514404297, 79.92803192138672, 0 ], 'job-forest', 'Дейв', 's_m_m_autoshop_01', {
            desc: "Работник лесопилки.",
            blip: 542,
            blipName: "Лесопилка"
        })
        npc.add([ -564.155517578125, 5269.005859375, 70.41380310058594, 119.48503875732422, 0 ], 'job-forest-rent-veh', 'Клаус', 's_m_m_gaffer_01', {
            desc: "Работник лесопилки.",
            blip: 665,
            blipName: "Лесопилка - Аренда транспорта"
        })
