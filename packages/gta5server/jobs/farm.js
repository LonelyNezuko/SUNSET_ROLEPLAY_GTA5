...
farm._playerJoin = player =>
{
    ...
    {
        user.setBlipDisplay(player, item.blip, 0)
    })
}
                        ...
                        player.npcDialogTrigger = button =>
                        {
                            ...
                            else
                            {
                                let typesText = [
                                    ...
                                    `Тебе необходимо отправиться к полям с яблонями и начать собирать яблоки с деревьев./nТебе нужно собрать 50 яблок, после чего отвезти их на склад и сдать./nЗа 1 яблоко я тебе заплачу ${func.formatCash(enums.jobSalary.farm[1])}/n/nЧуть не забыл... Поля с яблонями у нас далеко от сюда, поэтому можешь бесплатно взять в аренду квадрацикл у Венди.`,
                                    `Тебе необходимо отправиться к теплицам с томатами и начать собирать их./nТебе нужно собрать 50 томатов, после чего отвезти их на склад и сдать./nЗа 1 томат я тебе заплачу ${func.formatCash(enums.jobSalary.farm[2])}/n/nЧуть не забыл... Теплицы с томатами у нас далеко от сюда, поэтому можешь бесплатно взять в аренду квадрацикл у Венди.`,
