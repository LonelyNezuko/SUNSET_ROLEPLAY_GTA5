...
mp.events.add('server::noclip:getCamCoords', (name) => {
    mp.events.callRemote('client::noclip:saveCamCoords', JSON.stringify(coords), JSON.stringify(pointingAt(fly.point_distance)), name);
});
